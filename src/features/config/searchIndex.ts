...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    sectionId: 'network',
    labelKey: L('sections.network.transient_error_cooldown_seconds'),
    hintKey: L('sections.network.transient_error_cooldown_seconds_hint'),
    yamlKeys: ['transient-error-cooldown-seconds'],
    keywords: ['transient', 'cooldown', 'upstream', 'error'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['codex', 'identity', 'prompt cache', 'prompt_cache_key'],
  },
  {
    fieldId: 'codexStreamBootstrapBuffering',
    sectionId: 'advanced',
    labelKey: L('sections.system.codex_stream_bootstrap_buffering'),
    hintKey: L('sections.system.codex_stream_bootstrap_buffering_desc'),
    yamlKeys: ['codex', 'stream-bootstrap-buffering'],
    keywords: ['codex', 'bootstrap', 'buffering', 'handshake', 'stream'],
  },
